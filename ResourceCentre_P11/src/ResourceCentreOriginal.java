...
public class ResourceCentreOriginal {
	...
	public static void main(String[] args) {
		...
		while (option != 5) {
			...
			ResourceCentreOriginal.menu();
			option = Helper.readInt("Enter an option > ");

			if (option == 1) {
				// View all items
				ResourceCentreOriginal.viewAllCamcorder(camcorderList);
				ResourceCentreOriginal.viewAllChromebook(chromebookList);

			} else if (option == 2) {
				// Add a new item
				ResourceCentreOriginal.setHeader("ADD");			
				ResourceCentreOriginal.setHeader("ITEM TYPES");
				...
				if (itemType == 1) {
					...
					ResourceCentreOriginal.addCamcorder(camcorderList, cc);

				} else if (itemType == 2) {
					// Add Chromebook
					Chromebook cb = inputChromebook();
					ResourceCentreOriginal.addChromebook(chromebookList, cb);
				...
				// Loan item
				ResourceCentreOriginal.setHeader("LOAN");			
				ResourceCentreOriginal.setHeader("ITEM TYPES");
				System.out.println("1. Camcorder");
				System.out.println("2. Chromebook");
				...
				if (itemType == 1) {
					// Loan camcorder
					ResourceCentreOriginal.loanCamcorder(camcorderList);
				} else if (itemType == 2) {
					// Loan Chromebook
					ResourceCentreOriginal.loanChromebook(chromebookList);
				} else {
					System.out.println("Invalid type");
				}
				...
				// Return item
				ResourceCentreOriginal.setHeader("RETURN");				
				ResourceCentreOriginal.setHeader("ITEM TYPES");
				System.out.println("1. Camcorder");
				System.out.println("2. Chromebook");
				...
				if (itemType == 1) {
					// Return camcorder
					ResourceCentreOriginal.returnCamcorder(camcorderList);
				} else if (itemType == 2) {
					// Return Chromebook
					ResourceCentreOriginal.returnChromebook(chromebookList);
				} else {
					System.out.println("Invalid type");
				}
	...
	public static void menu() {
		ResourceCentreOriginal.setHeader("RESOURCE CENTRE APP");
	...
	public static String retrieveAllCamcorder(ArrayList<Camcorder> camcorderList) {
		...
		for (int i = 0; i < camcorderList.size(); i++) {
			...
			output += String.format("%-10s %-30s %-10s %-10s %-20d\n", camcorderList.get(i).getAssetTag(),
					...
					ResourceCentreOriginal.showAvailability(camcorderList.get(i).getIsAvailable()),
	...
	public static void viewAllCamcorder(ArrayList<Camcorder> camcorderList) {
		ResourceCentreOriginal.setHeader("CAMCORDER LIST");
	...
	public static String retrieveAllChromebook(ArrayList<Chromebook> chromebookList) {
		...
		for (int i = 0; i < chromebookList.size(); i++) {
			...
			output += String.format("%-10s %-30s %-10s %-10s %-20s\n", chromebookList.get(i).getAssetTag(),
					...
					ResourceCentreOriginal.showAvailability(chromebookList.get(i).getIsAvailable()),
	...
	public static void viewAllChromebook(ArrayList<Chromebook> chromebookList) {
		...
		ResourceCentreOriginal.setHeader("CHROMEBOOK LIST");
		String output = String.format("%-10s %-30s %-10s %-10s %-20s\n", "ASSET TAG", "DESCRIPTION",
